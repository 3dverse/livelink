...
function generateComponentAccessors(componentName, componentType, componentDescription) {
    ...
    get ${componentName}() : Components.${componentType} | undefined {
        return this._unsafeGetComponentValue({ component_name: "${componentName}" }) as Components.${componentType} | undefined;
    }
...
//------------------------------------------------------------------------------
function generateEntityComponents() {
    ...
    //--------------------------------------------------------------------------
    applyTemplate("EntityComponents.template.ts", path.join("EntityComponents.ts"), {
...
// ----------------------------------------------------------------------------
function generateSettingsProperties() {
    ...
    //--------------------------------------------------------------------------
    applyTemplate("SettingsProperties.template.ts", path.join("SettingsProperties.ts"), {
...
//------------------------------------------------------------------------------
generateEntityComponents();
//generateSettingsProperties();
