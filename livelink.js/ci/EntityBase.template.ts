 ...
 */
import type { Components, ComponentTypeName, EditorEntity, RTID, UUID } from "@3dverse/livelink.core";
...
export class EntityBase extends EventTarget {
     ...
     *
     */
    public static readonly component_names: Array<ComponentTypeName> = [
{{componentNames}}
    ];
...
{{componentAttributes}}
    ...
    public _isSerializableComponent(prop: PropertyKey, v: unknown): boolean {
        return (
            ...
            v !== undefined &&
            prop[0] !== "_" &&
            EntityBase.component_names.includes(prop as ComponentTypeName)
        );
    }
}
