        ...
        >
            <Canvas className={sampleCanvasClassName}>
                <Viewport className="w-full h-full">
                    ...
                    <DOM3DOverlay>
                        <DOM3DElement worldPosition={[2, 0, 0]} pixelDimensions={[1, 1]}>
                        ...
                        <DOM3DElement worldPosition={[-2, 1, 0]} pixelDimensions={[1, 1]} scaleFactor={0.0025}>
                        ...
                        <DOM3DElement worldPosition={[0, 0, -5]} pixelDimensions={[1, 1]} scaleFactor={0.0025}>
                            <>
                                <img
                        ...
                        <DOM3DElement worldPosition={[-3, 2, -1]} pixelDimensions={[1, 1]} scaleFactor={0.0025}>
