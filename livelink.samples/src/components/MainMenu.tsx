    ...
    return (
        <div>
            {isOpen && (
                <div
                    className={`
                        lg:hidden absolute top-0 left-0 w-screen h-full bg-color-underground transition-opacity opacity-0 cursor-pointer z-10
                        ${isOpen ? "opacity-80" : ""}
                    `}
                    onClick={onClose}
                />
            ...
            >
                <div
                    className="relative w-80 h-full flex flex-col bg-color-ground shadow-2xl lg:shadow-none z-10"
                    onClick={onClose}
                >
                    ...
                    <ul className="flex flex-col gap-6 h-full px-5 py-4 text-color-secondary overflow-auto">
